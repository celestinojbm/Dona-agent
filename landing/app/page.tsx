        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div data-reveal-group className="grid md:grid-cols-3 gap-6">
            {t.capabilities.items.map((cap, i) => {
              ...
              return (
                <div key={i} data-reveal data-spotlight data-tilt className="glass-card rounded-2xl p-8 h-full group">
      ...
      <section id="pricing" className="relative z-[2] section-space">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div data-reveal-group className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {/* Early Access */}
            <div data-reveal data-tilt className="glass-card rounded-2xl p-8 relative overflow-hidden">
            ...
            {/* Pro */}
            <div data-reveal data-tilt className="glass-card plan-destacado rounded-2xl p-8 relative overflow-hidden border-[#2563EB]/20">
            ...
            {/* Enterprise */}
            <div data-reveal data-tilt className="glass-card rounded-2xl p-8">
